...
def make_labels_matrix2(batch_size, num_classes, device):
    total = batch_size * num_classes
...
class Sampler():
    def __init__(self, args, data, labels, mask):
        ...
        # self.batch_size2 = set_batch_size(self.label_dict)

        self.label_matrix = make_labels_matrix(self.batch_size, self.num_classes, self.device)
        # self.label_matrix2= make_labels_matrix2(self.batch_size2, self.num_classes, self.device)
